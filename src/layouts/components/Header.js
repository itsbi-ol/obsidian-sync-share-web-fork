        ...
        <div className={"navbar bg-base-200 top-0 z-50 " + position}>
            <div className="flex-1">
                <div className="indicator ">
                    ...
                    <a href={containerRegistryUrl} target="_blank" className="btn btn-ghost normal-case text-xl ml-2">Notes Share</a>
                </div>
            </div>
            <div className="flex justify-end flex-1 px-2">
                <div className="flex items-stretch">
                    <a className="btn btn-ghost rounded-btn" href={serverSourceCodeUrl} target="_blank">
